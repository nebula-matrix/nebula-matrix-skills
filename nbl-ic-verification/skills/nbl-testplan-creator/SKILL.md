...
> **环境准备**：本技能依赖 `nbl-testplan` CLI 工具，使用前需安装。详见 [references/installation_guide.md](references/installation_guide.md)。
...
| Reference | 内容 | 何时读取 |
|-----------|------|----------|
| [references/installation_guide.md](references/installation_guide.md) | CLI 工具安装指南（有网/离线环境） | **开始工作前**安装 `nbl-testplan` 命令 |
